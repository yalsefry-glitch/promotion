...
<body>
  ...
  <script type="text/babel">
    ...
    const ENGINES = [
      { id:"veo-3.1", name:"Veo 3.1", tagline:"الأقوى للإعلانات الواقعية · 4K · صوت مدمج", pricePerSec:0.15, maxClipSec:8, badge:"موصى به" },
      { id:"kling-3.0", name:"Kling 3.0", tagline:"أفضل قيمة · ثبات الشخصية · نطق متعدد اللغات", pricePerSec:0.10, maxClipSec:15, badge:"اقتصادي" },
      { id:"wan-2.6", name:"Wan 2.6", tagline:"مسوّدات سريعة · 1080p · الأرخص", pricePerSec:0.05, maxClipSec:10, badge:"مسوّدة" },
    ];
    const ASPECTS = [
    ...
    function App(){
      ...
      const clips=Math.ceil(duration/engine.maxClipSec);
            ...
            <div className="col">
              ...
              <div className="card">
                ...
                <label className="field-label" style={{marginTop:18}}>
                  ...
                  {clips>1 && <span className="warn-chip">يتطلب دمج {clips} مقاطع</span>}
                </label>
                <div className="pill-row">
                  {DURATIONS.map(d=>(
...
function buildFalInput({ engineId, prompt, aspect, audio, duration }) {
  ...
  if (engineId.startsWith("veo")) {
    base.aspect_ratio = aspect;       // "9:16" | "1:1" | "16:9"
    base.audio_enabled = !!audio;
    if (duration) base.duration = `${duration}s`;
